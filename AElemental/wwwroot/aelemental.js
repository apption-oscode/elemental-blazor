...
const selectorTabbable = `
  ...
  textarea:not([disabled]):not([tabindex='-1']),
  iframe, object, embed, *[tabindex]:not([tabindex='-1']), *[contenteditable=true],
  ${prefix$s}-accordion-item,
  ${prefix$s}-btn,
  ${prefix$s}-breadcrumb-link,
  ${prefix$s}-checkbox,
  ${prefix$s}-code-snippet,
  ${prefix$s}-combo-box,
  ${prefix$s}-content-switcher-item,
  ${prefix$s}-copy-button,
  ${prefix$s}-table-header-row,
  ${prefix$s}-table-row,
  ${prefix$s}-table-toolbar-search,
  ${prefix$s}-date-picker-input,
  ${prefix$s}-dropdown,
  ${prefix$s}-input,
  ${prefix$s}-link,
  ${prefix$s}-number-input,
  ${prefix$s}-modal,
  ${prefix$s}-modal-close-button,
  ${prefix$s}-multi-select,
  ${prefix$s}-inline-notification,
  ${prefix$s}-toast-notification,
  ${prefix$s}-overflow-menu,
  ${prefix$s}-overflow-menu-item,
  ${prefix$s}-page-sizes-select,
  ${prefix$s}-pages-select,
  ${prefix$s}-progress-step,
  ${prefix$s}-radio-button,
  ${prefix$s}-search,
  ${prefix$s}-slider,
  ${prefix$s}-slider-input,
  ${prefix$s}-structured-list,
  ${prefix$s}-tab,
  ${prefix$s}-filter-tag,
  ${prefix$s}-textarea,
  ${prefix$s}-clickable-tile,
  ${prefix$s}-expandable-tile,
  ${prefix$s}-radio-tile,
  ${prefix$s}-selectable-tile,
  ${prefix$s}-toggle,
  ${prefix$s}-tooltip,
  ${prefix$s}-tooltip-definition,
  ${prefix$s}-tooltip-icon,
  ${prefix$s}-header-menu,
  ${prefix$s}-header-menu-button,
  ${prefix$s}-header-menu-item,
  ${prefix$s}-header-name,
  ${prefix$s}-header-nav-item,
  ${prefix$s}-side-nav-link,
  ${prefix$s}-side-nav-menu,
  ${prefix$s}-side-nav-menu-item
...
_decorate([customElement(`${prefix$r}-side-nav-menu-item`)], function (_initialize, _FocusMixin) {
    ...
    d: [{
      ...
      value: function render() {
        ...
        const classes = classMap({
          [`${prefix$r}--side-nav__link`]: true,
          [`${prefix$r}--side-nav__link--current`]: active
        });
        return html(_t$n || (_t$n = _$o` <a part="link" class="${0}" href="${0}"> <span part="title" class="${0}--side-nav__link-text"> <slot>${0}</slot> </span> </a> `), classes, href, prefix$r, title);
      }
      /**
...
_decorate([customElement(`${prefix$q}-header`)], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "render",
      value: function render() {
        return html(_t$m || (_t$m = _$n`<slot></slot>`));
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$p}-side-nav`)], function (_initialize, _HostListenerMixin) {
  ...
  return {
    ...
    d: [{
      ...
      key: "render",
      value: function render() {
        return html(_t$l || (_t$l = _$m`<slot></slot>`));
      }
      /**
      ...
      value: function selectorButtonToggle() {
        return `${prefix$p}-header-menu-button`;
      }
      /**
      ...
      value: function selectorNavItems() {
        return `${prefix$p}-side-nav-menu, ${prefix$p}-side-nav-menu-item, ${prefix$p}-side-nav-link`;
      }
      /**
      ...
      value: function eventButtonToggle() {
        return `${prefix$p}-header-menu-button-toggled`;
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$o}-side-nav-divider`)], function (_initialize, _LitElement) {
...
_decorate([customElement(`${prefix$n}-header-name`)], function (_initialize, _FocusMixin) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        const namePrefixPart = !namePrefix ? undefined : html(_t$k || (_t$k = _$l` <span part="prefix" class="${0}--header__name--prefix">${0}</span> `), prefix$n, namePrefix);
        return html(_t2$7 || (_t2$7 = _$l` <a part="link" class="${0}--header__name" href="${0}">${0}&nbsp;<slot></slot></a> `), prefix$n, ifDefined(href), namePrefixPart);
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$m}-header-nav`)], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return html(_t$j || (_t$j = _$k` <div part="divider" class="${0}-ce--header__divider"></div> <ul part="menu-body" class="${0}--header__menu-bar" aria-label="${0}"> <slot></slot> </ul> `), prefix$m, prefix$m, menuBarLabel);
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$l}-side-nav-link`)], function (_initialize, _FocusMixin) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        const classes = classMap({
          [`${prefix$l}--side-nav__link`]: true,
          [`${prefix$l}--side-nav__link--current`]: active
        });
        return html(_t$i || (_t$i = _$j` <a part="link" class="${0}" href="${0}"> <div id="title-icon-container" part="title-icon-container" hidden class="${0}--side-nav__icon"> <slot name="title-icon" @slotchange="${0}"></slot> </div> <span part="title" class="${0}--side-nav__link-text"> <slot>${0}</slot> </span> </a> `), classes, href, prefix$l, handleSlotChangeTitleIcon, prefix$l, title);
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$k}-header-menu`)], function (_initialize, _HostListenerMixin) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return html(_t$h || (_t$h = _$i` <a part="trigger" tabindex="0" class="${0}--header__menu-item ${0}--header__menu-title" href="javascript:void 0" aria-haspopup="menu" aria-expanded="${0}" @click="${0}" @keydown="${0}"> ${0}${0} </a> <ul part="menu-body" class="${0}--header__menu" aria-label="${0}"> <slot></slot> </ul> `), prefix$k, prefix$k, String(Boolean(expanded)), handleClick, handleKeydownTrigger, triggerContent, svgResultCarbonIcon$8({
          part: 'trigger-icon',
          class: `${prefix$k}--header__menu-arrow`
        }), prefix$k, ifDefined(menuLabel));
      }
      /**
      ...
      value: function selectorItem() {
        return `${prefix$k}-header-menu-item`;
      }
    }, {
      kind: "field",
      static: true,
...
let BXHeaderNavItem = _decorate([customElement(`${prefix$j}-header-nav-item`)], function (_initialize, _FocusMixin) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return html(_t$g || (_t$g = _$h` <a part="link" class="${0}--header__menu-item" tabindex="0" href="${0}"> <span part="title" class="${0}--text-truncate--end"><slot>${0}</slot></span> </a> `), prefix$j, ifDefined(href), prefix$j, title);
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$i}-header-menu-item`)], function (_initialize, _BXHeaderNavItem) {
...
_decorate([customElement(`${prefix$h}-side-nav-items`)], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "render",
      value: function render() {
        return html(_t$f || (_t$f = _$g`<slot></slot>`));
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$g}-header-menu-button`)], function (_initialize, _FocusMixin) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        const classes = classMap({
          [`${prefix$g}--header__action`]: true,
          [`${prefix$g}--header__menu-trigger`]: true,
          [`${prefix$g}--header__menu-toggle`]: true,
          [`${prefix$g}--header__action--active`]: active
        });
        return html(_t$e || (_t$e = _$f` <button part="button" class="${0}" ?disabled="${0}" aria-label="${0}" @click="${0}"> ${0} </button> `), classes, disabled, ifNonNull(buttonLabel), handleClick, (active ? svgResultCarbonIcon$7 : svgResultCarbonIcon$6)({
          slot: 'toggle-icon'
        }));
      }
      /**
      ...
      value: function eventToggle() {
        return `${prefix$g}-header-menu-button-toggled`;
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$f}-side-nav-menu`)], function (_initialize, _FocusMixin) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return html(_t$d || (_t$d = _$e` <button type="button" part="expando" aria-haspopup="true" aria-expanded="${0}" class="${0}--side-nav__submenu" @click="${0}"> <div id="title-icon-container" part="title-icon-container" hidden class="${0}--side-nav__icon"> <slot name="title-icon" @slotchange="${0}"></slot> </div> <span part="title" class="${0}--side-nav__submenu-title">${0}</span> <div part="expando-icon-container" class="${0}--side-nav__icon ${0}--side-nav__icon--small ${0}--side-nav__submenu-chevron"> ${0} </div> </button> <ul part="menu-body" class="${0}--side-nav__menu"> <slot @slotchange="${0}"></slot> </ul> `), String(Boolean(expanded && !forceCollapsed)), prefix$f, handleClickExpando, prefix$f, handleSlotChangeTitleIcon, prefix$f, title, prefix$f, prefix$f, prefix$f, svgResultCarbonIcon$5({
          part: 'expando-icon'
        }), prefix$f, handleSlotChange);
      }
      /**
      ...
      function selectorItem() {
        return `${prefix$f}-side-nav-menu-item`;
      }
      /**
      ...
      value: function eventBeforeToggle() {
        return `${prefix$f}-side-nav-menu-beingtoggled`;
      }
      /**
      ...
      key: "eventToggle",
      value: function eventToggle() {
        return `${prefix$f}-side-nav-menu-toggled`;
      }
    }, {
      kind: "field",
      static: true,
...
const _renderButton = ({
  ...
  className: _className = `${prefix$e}--snippet-button`,
  children: _children = html(_t$c || (_t$c = _$d` <slot>${0}</slot> `), svgResultCarbonIcon$4({
    class: `${prefix$e}--snippet__icon`
  })),
  handleClickButton
}) => {
  const feedbackClasses = classMap({
    [`${prefix$e}--btn--copy__feedback`]: true,
    [`${prefix$e}--btn--copy__feedback--displayed`]: _showFeedback
  });
  return html(_t2$6 || (_t2$6 = _$d` <button type="button" class="${0}" title="${0}" @click="${0}"> ${0} <div class="${0}" data-feedback="${0}"></div> </button> `), _className, ifDefined(assistiveText), handleClickButton, _children, feedbackClasses, ifDefined(feedbackText));
};
/**
 * Copy button.
...
_decorate([customElement(`${prefix$e}-copy-button`)], function (_initialize, _FocusMixin) {
...
const renderExpando = ({
  children,
  handleClick
}) => html(_t$b || (_t$b = _$c` <button type="button" class="${0}--snippet-btn--expand" @click="${0}"> <span id="button-text" class="${0}--snippet-btn--text"> ${0} </span> ${0} </button> `), prefix$d, handleClick, prefix$d, children, svgResultCarbonIcon$8({
  'aria-labeledby': 'button-text',
  class: `${prefix$d}--icon-chevron--down ${prefix$d}--snippet__icon`,
  role: 'img'
}));
/**
 * @param values The values to render.
...
const renderCode = ({
  ...
  const classes = classMap({
    [`${prefix$d}--snippet-container`]: true,
    [`${prefix$d}-ce--snippet-container--expanded`]: Boolean(expanded)
  }); // Ensures no extra whitespace text node
  // prettier-ignore

  return html(_t2$5 || (_t2$5 = _$c` <div role="textbox" tabindex="0" class="${0}" aria-label="${0}"><code><pre>${0}</pre></code></div> `), classes, assistiveText, children);
};
/**
 * Basic code snippet.
...
_decorate([customElement(`${prefix$d}-code-snippet`)], function (_initialize, _FocusMixin) {
  ...
  return {
    ...
    d: [{
      ...
      function _handleClickCopyButton() {
        ...
        code.className = `${prefix$d}--visually-hidden`;
      ...
      value: function render() {
        ...
        if (type === CODE_SNIPPET_TYPE.SINGLE) {
          // Ensures no extra whitespace text node
          // prettier-ignore
          return html(_t3$5 || (_t3$5 = _$c` ${0} ${0} `), renderCode({
            assistiveText: codeAssistiveText,
            expanded,
            children: html(_t4$3 || (_t4$3 = _$c`<slot @slotchange="${0}"></slot>`), handleSlotChange)
          }), _renderButton({
            ...
            className: `${prefix$d}--snippet-button`
          }));
        }
        ...
        if (type === CODE_SNIPPET_TYPE.MULTI) {
          // Ensures no extra whitespace text node
          // prettier-ignore
          return html(_t5$3 || (_t5$3 = _$c` ${0} ${0} ${0} `), renderCode({
            assistiveText: codeAssistiveText,
            expanded,
            children: html(_t6$1 || (_t6$1 = _$c`<slot @slotchange="${0}"></slot>`), handleSlotChange)
          }), _renderButton({
            assistiveText: copyButtonAssistiveText,
            feedbackText: copyButtonFeedbackText,
            showFeedback: showCopyButtonFeedback,
            ...
            children: expanded ? html(_t7$1 || (_t7$1 = _$c`<slot name="collapse-button-text">${0}</slot>`), collapseButtonText) : html(_t8 || (_t8 = _$c`<slot name="expand-button-text">${0}</slot>`), expandButtonText),
        ...
        return html(_t9 || (_t9 = _$c` ${0} `), _renderButton({
          assistiveText: copyButtonAssistiveText,
          feedbackText: copyButtonFeedbackText,
          showFeedback: showCopyButtonFeedback,
          handleClickButton: handleClickCopyButton,
          className: `${prefix$d}--snippet ${prefix$d}--snippet--inline`,
          children: html(_t10 || (_t10 = _$c`<code aria-label="${0}"><slot></slot></code>`), codeAssistiveText)
        }));
      }
    }, {
      kind: "field",
...
_decorate([customElement(`${prefix$c}-code-snippet-skeleton`)], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
       ...
       */
      function render() {
        return html(_t$a || (_t$a = _$b` <div class="${0}--snippet-container"> ${0} </div> `), prefix$c, this.type !== CODE_SNIPPET_TYPE.MULTI ? html(_t2$4 || (_t2$4 = _$b` <span></span> `)) : html(_t3$4 || (_t3$4 = _$b` <span></span><span></span><span></span> `)));
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$b}-dropdown`)], function (_initialize, _ValidityMixin) {
  ...
  return {
    ...
    d: [{
      ...
      kind: "field",
      decorators: [query(`.${prefix$b}--list-box`)],
      key: "_listBoxNode",
      value: void 0
    }, {
      kind: "field",
      ...
      value: function _renderTriggerContent() {
        ...
        return html(_t$9 || (_t$9 = _$a` <span id="trigger-label" class="${0}--list-box__label">${0}</span> `), prefix$b, selectedItemContent || triggerContent);
      }
      /* eslint-disable class-methods-use-this */
      ...
      value: function render() {
        ...
        const classes = classMap({
          [`${prefix$b}--dropdown`]: true,
          [`${prefix$b}--list-box`]: true,
          [`${prefix$b}--list-box--${colorScheme}`]: colorScheme,
          [`${prefix$b}--list-box--disabled`]: disabled,
          [`${prefix$b}--list-box--inline`]: inline,
          [`${prefix$b}--list-box--expanded`]: open,
          [`${prefix$b}--list-box--${size}`]: size,
          [`${prefix$b}--dropdown--invalid`]: invalid,
          [`${prefix$b}--dropdown--inline`]: inline,
          [`${prefix$b}--dropdown--selected`]: selectedItemsCount > 0
        });
        const labelClasses = classMap({
          [`${prefix$b}--label`]: true,
          [`${prefix$b}--label--disabled`]: disabled
        });
        const helperClasses = classMap({
          [`${prefix$b}--form__helper-text`]: true,
          [`${prefix$b}--form__helper-text--disabled`]: disabled
        });
        const iconContainerClasses = classMap({
          [`${prefix$b}--list-box__menu-icon`]: true,
          [`${prefix$b}--list-box__menu-icon--open`]: open
        });
        ...
        const helper = !invalid ? html(_t2$3 || (_t2$3 = _$a` <div part="helper-text" class="${0}" ?hidden="${0}"> <slot name="helper-text" @slotchange="${0}">${0}</slot> </div> `), helperClasses, inline || !hasHelperText, handleSlotchangeHelperText, helperText) : html(_t3$3 || (_t3$3 = _$a` <div part="validity-message" class="${0}"> <slot name="validity-message">${0}</slot> </div> `), `${prefix$b}--form-requirement`, validityMessage);
        const validityIcon = !invalid ? undefined : svgResultCarbonIcon$3({
          class: `${prefix$b}--list-box__invalid-icon`,
          'aria-label': toggleLabel
        });
        const menuBody = !open ? undefined : html(_t4$2 || (_t4$2 = _$a` <div id="menu-body" part="menu-body" class="${0}--list-box__menu" role="listbox" tabindex="-1"> <slot></slot> </div> `), prefix$b);
        return html(_t5$2 || (_t5$2 = _$a` <label part="label-text" class="${0}" ?hidden="${0}"> <slot name="label-text" @slotchange="${0}">${0}</slot> </label> <div role="listbox" class="${0}" ?data-invalid="${0}" @click="${0}" @keydown="${0}" @keypress="${0}"> ${0} <div part="trigger-button" role="${0}" class="${0}--list-box__field" tabindex="${0}" aria-labelledby="trigger-label" aria-expanded="${0}" aria-haspopup="listbox" aria-owns="menu-body" aria-controls="menu-body"> ${0}${0}${0} <div class="${0}">${0}</div> </div> ${0} </div> ${0} <div class="${0}--assistive-text" role="status" aria-live="assertive" aria-relevant="additions text"> ${0} </div> `), labelClasses, !hasLabelText, handleSlotchangeLabelText, labelText, classes, invalid, handleClickInner, handleKeydownInner, handleKeypressInner, validityIcon, ifDefined(!shouldTriggerBeFocusable ? undefined : 'button'), prefix$b, ifDefined(!shouldTriggerBeFocusable ? undefined : '0'), String(open), this._renderPrecedingTriggerContent(), this._renderTriggerContent(), this._renderFollowingTriggerContent(), iconContainerClasses, svgResultCarbonIcon$8({
          'aria-label': toggleLabel
        }), menuBody, helper, prefix$b, assistiveStatusText);
      }
      /**
      ...
      function selectorItemHighlighted() {
        return `${prefix$b}-dropdown-item[highlighted]`;
      }
      /**
      ...
      value: function selectorItemSelected() {
        return `${prefix$b}-dropdown-item[selected]`;
      }
      /**
      ...
      value: function eventBeforeSelect() {
        return `${prefix$b}-dropdown-beingselected`;
      }
      /**
      ...
      value: function eventSelect() {
        return `${prefix$b}-dropdown-selected`;
      }
      /**
      ...
      key: "eventBeforeToggle",
      value: function eventBeforeToggle() {
        return `${prefix$b}-dropdown-beingtoggled`;
      }
      /**
      ...
      key: "eventToggle",
      value: function eventToggle() {
        return `${prefix$b}-dropdown-toggled`;
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$a}-dropdown-item`)], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      function render() {
        ...
        return html(_t$8 || (_t$8 = _$9` <div class="${0}--list-box__menu-item__option"> <slot></slot> ${0} </div> `), prefix$a, !selected ? undefined : svgResultCarbonIcon$2({
          part: 'selected-icon',
          class: `${prefix$a}--list-box__menu-item__selected-icon`
        }));
      }
    }, {
      kind: "field",
...
_decorate([customElement(`${prefix$9}-dropdown-skeleton`)], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "render",
      value: function render() {
        return html(_t$7 || (_t$7 = _$8` <div class="${0}--skeleton ${0}--dropdown-v2 ${0}--list-box ${0}--form-item"> <div class="${0}--list-box__field"> <span class="${0}--list-box__label"></span> </div> </div> `), prefix$9, prefix$9, prefix$9, prefix$9, prefix$9, prefix$9);
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$8}-progress-indicator`)], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "render",
      value: function render() {
        return html(_t$6 || (_t$6 = _$7`<slot></slot>`));
      }
      /**
...
_decorate([customElement(`${prefix$7}-progress-step`)], function (_initialize, _FocusMixin) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return html(_t3$2 || (_t3$2 = _$6` ${0} <slot> <p role="button" class="${0}--progress-label" tabindex="0" aria-describedby="label-tooltip">${0}</p> </slot> <slot name="secondary-label-text"> ${0} </slot> <span class="${0}--progress-line"></span> `), icons[state]({
          class: {
            [PROGRESS_STEP_STAT.INVALID]: `${prefix$7}--progress__warning`
          }[state],
          children: !iconLabel ? undefined : svg(_t4$1 || (_t4$1 = _$6`<title>${0}</title>`), iconLabel)
        }), prefix$7, labelText, !secondaryLabelText ? undefined : html(_t5$1 || (_t5$1 = _$6` <p class="${0}--progress-optional">${0}</p> `), prefix$7, secondaryLabelText), prefix$7);
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$6}-progress-step-skeleton`)], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
       ...
       */
      function render() {
        return html(_t$4 || (_t$4 = _$5` <div class="${0}--progress-step-button ${0}--progress-step-button--unclickable"> <svg> <path d="M 7, 7 m -7, 0 a 7,7 0 1,0 14,0 a 7,7 0 1,0 -14,0"/> </svg> <p class="${0}--progress-label"></p> <span class="${0}--progress-line"></span> </div> `), prefix$6, prefix$6, prefix$6, prefix$6);
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$5}-input`)], function (_initialize, _ValidityMixin) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        const invalidIcon = svgResultCarbonIcon$3({
          class: `${prefix$5}--text-input__invalid-icon`
        });
        const inputClasses = classMap({
          [`${prefix$5}--text-input`]: true,
          [`${prefix$5}--text-input--${this.colorScheme}`]: this.colorScheme,
          [`${prefix$5}--text-input--invalid`]: this.invalid,
          [`${prefix$5}--text-input--${this.size}`]: this.size
        });
        const labelClasses = classMap({
          [`${prefix$5}--label`]: true,
          [`${prefix$5}--label--disabled`]: this.disabled
        });
        const helperTextClasses = classMap({
          [`${prefix$5}--form__helper-text`]: true,
          [`${prefix$5}--form__helper-text--disabled`]: this.disabled
        });
        return html(_t$3 || (_t$3 = _$4` <label class="${0}" for="input"> <slot name="label-text"> ${0} </slot> </label> <div class="${0}--text-input__field-wrapper" ?data-invalid="${0}"> ${0} <input ?autocomplete="${0}" ?autofocus="${0}" class="${0}" ?data-invalid="${0}" ?disabled="${0}" id="input" name="${0}" pattern="${0}" placeholder="${0}" ?readonly="${0}" ?required="${0}" type="${0}" .value="${0}" @input="${0}"> </div> <div class="${0}"> <slot name="helper-text"> ${0} </slot> </div> <div class="${0}--form-requirement"> <slot name="validity-message"> ${0} </slot> </div> `), labelClasses, this.labelText, prefix$5, this.invalid, this.invalid ? invalidIcon : null, this.autocomplete, this.autofocus, inputClasses, this.invalid, this.disabled, ifNonEmpty(this.name), ifNonEmpty(this.pattern), ifNonEmpty(this.placeholder), this.readonly, this.required, ifNonEmpty(this.type), this._value, handleInput, helperTextClasses, this.helperText, prefix$5, this.validityMessage);
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$4}-select`)], function (_initialize, _ValidityMixin) {
  ...
  return {
    ...
    d: [{
      ...
      value() {
        return `__${prefix$4}-select-placeholder_${Math.random().toString(36).slice(2)}`;
      }
      ...
      function _renderItems(element) {
        ...
        return html(_t$2 || (_t$2 = _$3` ${0} `), filter(element.childNodes, item => item.nodeType === Node.ELEMENT_NODE && item.matches(selectorItem)).map(item => {
          ...
          return item.matches(selectorLeafItem) ? html(_t2$1 || (_t2$1 = _$3` <option class="${0}--select-option" ?disabled="${0}" label="${0}" ?selected="${0}" value="${0}"> ${0} </option> `), prefix$4, disabled, ifNonNull(label !== null && label !== void 0 ? label : textContent), selected, ifNonNull(value), textContent) : html(_t3$1 || (_t3$1 = _$3` <optgroup class="${0}--select-optgroup" ?disabled="${0}" label="${0}"> ${0} </optgroup> `), prefix$4, disabled, ifNonNull(label), this._renderItems(item));
        }));
      }
    }, {
      kind: "method",
      ...
      value: function render() {
        ...
        const inputClasses = classMap({
          [`${prefix$4}--select-input`]: true,
          [`${prefix$4}--select-input--${size}`]: size
        });
        const labelClasses = classMap({
          [`${prefix$4}--label`]: true,
          [`${prefix$4}--label--disabled`]: disabled
        });
        const helperTextClasses = classMap({
          [`${prefix$4}--form__helper-text`]: true,
          [`${prefix$4}--form__helper-text--disabled`]: disabled
        });
        const supplementalText = !invalid ? html(_t4 || (_t4 = _$3` <div class="${0}"> <slot name="helper-text"> ${0} </slot> </div> `), helperTextClasses, helperText) : html(_t5 || (_t5 = _$3` <div class="${0}--form-requirement" id="validity-message"> <slot name="validity-message"> ${0} </slot> </div> `), prefix$4, validityMessage);
        return html(_t6 || (_t6 = _$3` <label class="${0}" for="input"> <slot name="label-text"> ${0} </slot> </label> <div class="${0}--select-input__wrapper" ?data-invalid="${0}"> <select id="input" class="${0}" ?disabled="${0}" aria-invalid="${0}" aria-describedby="${0}" @input="${0}"> ${0} ${0} </select> ${0} ${0} </div> ${0} `), labelClasses, labelText, prefix$4, invalid, inputClasses, disabled, String(Boolean(invalid)), ifDefined(!invalid ? undefined : 'validity-message'), handleInput, !placeholder || value ? undefined : html(_t7 || (_t7 = _$3` <option disabled="disabled" hidden class="${0}--select-option" value="${0}" selected="selected"> ${0} </option> `), prefix$4, placeholderItemValue, placeholder), this._renderItems(this), svgResultCarbonIcon$8({
          class: `${prefix$4}--select__arrow`
        }), !invalid ? undefined : svgResultCarbonIcon$3({
          class: `${prefix$4}--select__invalid-icon`
        }), supplementalText);
      }
      /**
      ...
      key: "selectorItem",
      value: function selectorItem() {
        return `${prefix$4}-select-item-group,${prefix$4}-select-item`;
      }
      /**
      ...
      key: "eventSelect",
      value: function eventSelect() {
        return `${prefix$4}-select-selected`;
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$3}-select-item`)], function (_initialize, _LitElement) {
...
_decorate([customElement(`${prefix$2}-select-item-group`)], function (_initialize, _LitElement) {
