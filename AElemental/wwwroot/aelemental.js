  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        if (href) {
          return disabled ? html(_t$f || (_t$f = _$f` <p id="button" part="button" class="${0}"> <slot @slotchange="${0}"></slot> <slot name="icon" @slotchange="${0}"></slot> </p> `), classes, handleSlotChange, handleSlotChange) : html(_t2$5 || (_t2$5 = _$f` <a id="button" part="button" role="${0}" class="${0}" download="${0}" href="${0}" hreflang="${0}" ping="${0}" rel="${0}" target="${0}" type="${0}"> <slot @slotchange="${0}"></slot> <slot name="icon" @slotchange="${0}"></slot> </a> `), ifNonNull(linkRole), classes, ifNonNull(download), ifNonNull(href), ifNonNull(hreflang), ifNonNull(ping), ifNonNull(rel), ifNonNull(target), ifNonNull(type), handleSlotChange, handleSlotChange);
        }

        return html(_t3$2 || (_t3$2 = _$f` <button id="button" part="button" class="${0}" ?autofocus="${0}" ?disabled="${0}" type="${0}"> <slot @slotchange="${0}"></slot> <slot name="icon" @slotchange="${0}"></slot> </button> `), classes, autofocus, disabled, ifNonNull(type), handleSlotChange, handleSlotChange);
      }
    }, {
      kind: "field",
      static: true,
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return href ? html(_t$e || (_t$e = _$e` <a id="button" role="button" class="${0}" download="${0}" href="${0}" hreflang="${0}" ping="${0}" rel="${0}" target="${0}" type="${0}" @click="${0}"></a> `), classes, ifNonNull(download), ifNonNull(href), ifNonNull(hreflang), ifNonNull(ping), ifNonNull(rel), ifNonNull(target), ifNonNull(type), this._handleClickLinkSkeleton) : html(_t2$4 || (_t2$4 = _$e` <button id="button" class="${0}" ?autofocus="${0}" ?disabled="${0}" type="${0}"></button> `), classes, autofocus, disabled, ifNonNull(type));
      }
    }, {
      kind: "field",
      static: true,
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return html(_t$d || (_t$d = _$d` <a part="link" class="${0}" href="${0}"> <span part="title" class="${0}--side-nav__link-text"> <slot>${0}</slot> </span> </a> `), classes, href, prefix$f, title);
      }
      /**
...
_decorate([customElement(`${prefix$e}-header`)], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "render",
      value: function render() {
        return html(_t$c || (_t$c = _$c`<slot></slot>`));
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$d}-side-nav`)], function (_initialize, _HostListenerMixin) {
  ...
  return {
    ...
    d: [{
      ...
      key: "render",
      value: function render() {
        return html(_t$b || (_t$b = _$b`<slot></slot>`));
      }
      /**
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        const namePrefixPart = !namePrefix ? undefined : html(_t$a || (_t$a = _$a` <span part="prefix" class="${0}--header__name--prefix">${0}</span> `), prefix$b, namePrefix);
        return html(_t2$3 || (_t2$3 = _$a` <a part="link" class="${0}--header__name" href="${0}">${0}&nbsp;<slot></slot></a> `), prefix$b, ifDefined(href), namePrefixPart);
      }
    }, {
      kind: "field",
      static: true,
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return html(_t$9 || (_t$9 = _$9` <div part="divider" class="${0}-ce--header__divider"></div> <ul part="menu-body" class="${0}--header__menu-bar" aria-label="${0}"> <slot></slot> </ul> `), prefix$a, prefix$a, menuBarLabel);
      }
    }, {
      kind: "field",
      static: true,
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return html(_t$8 || (_t$8 = _$8` <a part="link" class="${0}" href="${0}"> <div id="title-icon-container" part="title-icon-container" hidden class="${0}--side-nav__icon"> <slot name="title-icon" @slotchange="${0}"></slot> </div> <span part="title" class="${0}--side-nav__link-text"> <slot>${0}</slot> </span> </a> `), classes, href, prefix$9, handleSlotChangeTitleIcon, prefix$9, title);
      }
    }, {
      kind: "field",
      static: true,
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return html(_t$6 || (_t$6 = _$6` <a part="link" class="${0}--header__menu-item" tabindex="0" href="${0}"> <span part="title" class="${0}--text-truncate--end"><slot>${0}</slot></span> </a> `), prefix$7, ifDefined(href), prefix$7, title);
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$5}-side-nav-items`)], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "render",
      value: function render() {
        return html(_t$5 || (_t$5 = _$5`<slot></slot>`));
      }
    }, {
      kind: "field",
      static: true,
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return html(_t$4 || (_t$4 = _$4` <button part="button" class="${0}" ?disabled="${0}" aria-label="${0}" @click="${0}"> ${0} </button> `), classes, disabled, ifNonNull(buttonLabel), handleClick, (active ? svgResultCarbonIcon$3 : svgResultCarbonIcon$2)({
          slot: 'toggle-icon'
        }));
      }
      /**
...
const _renderButton = ({
  ...
  children: _children = html(_t$2 || (_t$2 = _$2` <slot>${0}</slot> `), svgResultCarbonIcon({
  ...
  return html(_t2$2 || (_t2$2 = _$2` <button type="button" class="${0}" title="${0}" @click="${0}"> ${0} <div class="${0}" data-feedback="${0}"></div> </button> `), _className, ifDefined(assistiveText), handleClickButton, _children, feedbackClasses, ifDefined(feedbackText));
};
/**
 * Copy button.
...
const renderExpando = ({
  children,
  handleClick
}) => html(_t$1 || (_t$1 = _$1` <button type="button" class="${0}--snippet-btn--expand" @click="${0}"> <span id="button-text" class="${0}--snippet-btn--text"> ${0} </span> ${0} </button> `), prefix$1, handleClick, prefix$1, children, svgResultCarbonIcon$4({
...
const renderCode = ({
  ...
  return html(_t2$1 || (_t2$1 = _$1` <div role="textbox" tabindex="0" class="${0}" aria-label="${0}"><code><pre>${0}</pre></code></div> `), classes, assistiveText, children);
};
/**
 * Basic code snippet.
    ...
    d: [{
      ...
      value: function render() {
        ...
        if (type === CODE_SNIPPET_TYPE.SINGLE) {
          // Ensures no extra whitespace text node
          // prettier-ignore
          return html(_t3$1 || (_t3$1 = _$1` ${0} ${0} `), renderCode({
            assistiveText: codeAssistiveText,
            expanded,
            children: html(_t4 || (_t4 = _$1`<slot @slotchange="${0}"></slot>`), handleSlotChange)
          }), _renderButton({
        ...
        if (type === CODE_SNIPPET_TYPE.MULTI) {
          // Ensures no extra whitespace text node
          // prettier-ignore
          return html(_t5 || (_t5 = _$1` ${0} ${0} ${0} `), renderCode({
            assistiveText: codeAssistiveText,
            expanded,
            children: html(_t6 || (_t6 = _$1`<slot @slotchange="${0}"></slot>`), handleSlotChange)
          }), _renderButton({
            assistiveText: copyButtonAssistiveText,
            feedbackText: copyButtonFeedbackText,
            showFeedback: showCopyButtonFeedback,
            ...
            children: expanded ? html(_t7 || (_t7 = _$1`<slot name="collapse-button-text">${0}</slot>`), collapseButtonText) : html(_t8 || (_t8 = _$1`<slot name="expand-button-text">${0}</slot>`), expandButtonText),
        ...
        return html(_t9 || (_t9 = _$1` ${0} `), _renderButton({
          assistiveText: copyButtonAssistiveText,
          feedbackText: copyButtonFeedbackText,
          showFeedback: showCopyButtonFeedback,
          handleClickButton: handleClickCopyButton,
          className: `${prefix$1}--snippet ${prefix$1}--snippet--inline`,
          children: html(_t10 || (_t10 = _$1`<code aria-label="${0}"><slot></slot></code>`), codeAssistiveText)
        }));
      }
    }, {
      kind: "field",
