...
const selectorTabbable = `
  ...
  textarea:not([disabled]):not([tabindex='-1']),
  iframe, object, embed, *[tabindex]:not([tabindex='-1']), *[contenteditable=true],
  ${prefix$f}-accordion-item,
  ${prefix$f}-btn,
  ${prefix$f}-breadcrumb-link,
  ${prefix$f}-checkbox,
  ${prefix$f}-code-snippet,
  ${prefix$f}-combo-box,
  ${prefix$f}-content-switcher-item,
  ${prefix$f}-copy-button,
  ${prefix$f}-table-header-row,
  ${prefix$f}-table-row,
  ${prefix$f}-table-toolbar-search,
  ${prefix$f}-date-picker-input,
  ${prefix$f}-dropdown,
  ${prefix$f}-input,
  ${prefix$f}-link,
  ${prefix$f}-number-input,
  ${prefix$f}-modal,
  ${prefix$f}-modal-close-button,
  ${prefix$f}-multi-select,
  ${prefix$f}-inline-notification,
  ${prefix$f}-toast-notification,
  ${prefix$f}-overflow-menu,
  ${prefix$f}-overflow-menu-item,
  ${prefix$f}-page-sizes-select,
  ${prefix$f}-pages-select,
  ${prefix$f}-progress-step,
  ${prefix$f}-radio-button,
  ${prefix$f}-search,
  ${prefix$f}-slider,
  ${prefix$f}-slider-input,
  ${prefix$f}-structured-list,
  ${prefix$f}-tab,
  ${prefix$f}-filter-tag,
  ${prefix$f}-textarea,
  ${prefix$f}-clickable-tile,
  ${prefix$f}-expandable-tile,
  ${prefix$f}-radio-tile,
  ${prefix$f}-selectable-tile,
  ${prefix$f}-toggle,
  ${prefix$f}-tooltip,
  ${prefix$f}-tooltip-definition,
  ${prefix$f}-tooltip-icon,
  ${prefix$f}-header-menu,
  ${prefix$f}-header-menu-button,
  ${prefix$f}-header-menu-item,
  ${prefix$f}-header-name,
  ${prefix$f}-header-nav-item,
  ${prefix$f}-side-nav-link,
  ${prefix$f}-side-nav-menu,
  ${prefix$f}-side-nav-menu-item
...
let BXButton = _decorate([customElement(`${prefix$e}-btn`)], function (_initialize, _HostListenerMixin) {
    ...
    d: [{
      ...
      value: function render() {
        ...
        const classes = classMap({
          [`${prefix$e}--btn`]: true,
          [`${prefix$e}--btn--${kind}`]: kind,
          [`${prefix$e}--btn--disabled`]: disabled,
          [`${prefix$e}--btn--icon-only`]: hasIcon && !hasMainContent,
          [`${prefix$e}--btn--sm`]: size === 'sm' && !isExpressive,
          [`${prefix$e}--btn--xl`]: size === 'xl',
          [`${prefix$e}--btn--field`]: size === 'field' && !isExpressive,
          [`${prefix$e}-ce--btn--has-icon`]: hasIcon,
          [`${prefix$e}--btn--expressive`]: isExpressive
        });

        if (href) {
          return disabled ? html(_t$c || (_t$c = _$c` <p id="button" part="button" class="${0}"> <slot @slotchange="${0}"></slot> <slot name="icon" @slotchange="${0}"></slot> </p> `), classes, handleSlotChange, handleSlotChange) : html(_t2$2 || (_t2$2 = _$c` <a id="button" part="button" role="${0}" class="${0}" download="${0}" href="${0}" hreflang="${0}" ping="${0}" rel="${0}" target="${0}" type="${0}"> <slot @slotchange="${0}"></slot> <slot name="icon" @slotchange="${0}"></slot> </a> `), ifNonNull(linkRole), classes, ifNonNull(download), ifNonNull(href), ifNonNull(hreflang), ifNonNull(ping), ifNonNull(rel), ifNonNull(target), ifNonNull(type), handleSlotChange, handleSlotChange);
        }

        return html(_t3 || (_t3 = _$c` <button id="button" part="button" class="${0}" ?autofocus="${0}" ?disabled="${0}" type="${0}"> <slot @slotchange="${0}"></slot> <slot name="icon" @slotchange="${0}"></slot> </button> `), classes, autofocus, disabled, ifNonNull(type), handleSlotChange, handleSlotChange);
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$d}-btn-skeleton`)], function (_initialize, _BXButton) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        const classes = classMap({
          [`${prefix$d}--btn`]: true,
          [`${prefix$d}--skeleton`]: true,
          [`${prefix$d}--btn--${size}`]: size
        });
        return href ? html(_t$b || (_t$b = _$b` <a id="button" role="button" class="${0}" download="${0}" href="${0}" hreflang="${0}" ping="${0}" rel="${0}" target="${0}" type="${0}" @click="${0}"></a> `), classes, ifNonNull(download), ifNonNull(href), ifNonNull(hreflang), ifNonNull(ping), ifNonNull(rel), ifNonNull(target), ifNonNull(type), this._handleClickLinkSkeleton) : html(_t2$1 || (_t2$1 = _$b` <button id="button" class="${0}" ?autofocus="${0}" ?disabled="${0}" type="${0}"></button> `), classes, autofocus, disabled, ifNonNull(type));
      }
    }, {
      kind: "field",
      static: true,
...
_decorate([customElement(`${prefix$5}-header-menu`)], function (_initialize, _HostListenerMixin) {
...
_decorate([customElement(`${prefix$1}-header-menu-button`)], function (_initialize, _FocusMixin) {
